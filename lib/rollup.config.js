 ...
 *
 * @param bundleType - Specifies the type of the bundle.
 *
 ...
 *
 * @param bundleType - Specifies the type of the bundle.
 * @param polyfill - Specifies if the bundle should be polyfilled or not.
 * @param env - Specifies if the bundle is for production or development.
 *
